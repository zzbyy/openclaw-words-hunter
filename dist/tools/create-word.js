...
async function loadTemplate(config, word, date) {
 ...
 */
export async function createWord(config, params) {
...
async function runLookup(config, word) {
    try {
        ...
        if (e instanceof CambridgeBlockedError)
            return 'blocked';
        return 'failed';
    }
}
//# sourceMappingURL=create-word.js.map