 ...
 */
export async function scanVault(config, filter, today = todayString()) {
    ...
    const entries = Object.values(store.words).filter(e => existingFiles.has(`${e.word.toLowerCase()}.md`));
    if (filter === 'due') {
        const due = entries
...
//# sourceMappingURL=scan-vault.js.map