 ...
 */
export function renderMasteryCallout(entry) {
    const lines = [
        '> [!mastery]',
        `> **Status:** ${entry.status}`,
 ...
 */
export function upsertCallout(pageContent, entry) {
    ...
    if (match) {
        ...
        return (pageContent.slice(0, insertAt) +
            '\n' + newCallout + '\n' +
...
//# sourceMappingURL=callout-renderer.js.map