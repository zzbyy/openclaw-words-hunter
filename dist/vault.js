...
// Config loading
// ============================================================
export async function loadVaultConfig(vaultRoot) {
    ...
    const vaultPath = obj['vault_path'];
    try {
...
export function assertInVault(vaultRoot, resolvedPath) {
...
// mastery.json I/O
// ============================================================
export async function readMasteryStore(jsonPath) {
    let raw;
    try {
...
export async function writeMasteryStore(jsonPath, store) {
...
// ============================================================
export async function readNudgeQueue(queuePath) {
    try {
...
export async function writeNudgeQueue(queuePath, queue) {
